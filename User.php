...
class User extends CI_Controller{
    ...
    {   
		...
		$this->form_validation->set_rules('name', 'Name', 'trim|required|xss_clean|alpha_numeric');
			...
			$this->form_validation->set_rules('mobile','Mobile','min_length[6]|max_length[10]|required');
    ...
    {   
        ...
        if(isset($data['user']['id']))
        {
			...
			$this->form_validation->set_rules('name','Name','max_length[255]|required');
			$this->form_validation->set_rules('email','Email','max_length[255]|required|valid_email');
			$this->form_validation->set_rules('mobile','Mobile','max_length[255]|required');
...
function show($id)
    {   
        ...
        if(isset($data['user']['id']))
        {
                ...
                $data['_view'] = 'user/show';
                $this->load->view('layouts/main',$data);
            
        }
        else
            show_error('The user you are trying to show does not exist.');
    } 
    /*
     * Deleting user
     */
